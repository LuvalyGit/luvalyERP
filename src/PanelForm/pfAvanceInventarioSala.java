 ...
 * @author informática
 */
public class pfAvanceInventarioSala extends javax.swing.JPanel {
    public static Color DARK_GREEN = new Color(0,153,0);
    DecimalFormat formateador = new DecimalFormat("###,###");
    DefaultTableCellRenderer rightRenderer = new DefaultTableCellRenderer();
    String Sku = "";
   
    public pfAvanceInventarioSala() {
        initComponents();
    ...
    private void Carga_Indicadores(){
        ...
        try{
            ...
            Query = "select sum(mt.cant) itemscontados \n" +
                    ...
                    "where mt.ubicacion LIKE '%THSAL.%' or mt.ubicacion LIKE '%THPAT.%'";
        ...
        //************************* AVANCE **********************************//
           ...
           double avanceitems = (items / (items+items2));
    ...
    private void AvanceUsuarios(){
        ...
        try {
            ...
            Logger.getLogger(pfAvanceInventarioSala.class.getName()).log(Level.SEVERE, null, ex);
        }
