 ...
 */
public class pfUsuarios_old extends javax.swing.JPanel {
...
//        jPanel4.setVisible(false);
    ...
    private void initComponents() {
        ...
        chkChileCompras = new javax.swing.JCheckBox();
        chkEcona = new javax.swing.JCheckBox();
        ...
        chkNoAsigna = new javax.swing.JCheckBox();
        ...
        jPanel4.setBorder(javax.swing.BorderFactory.createTitledBorder("Separador"));

        chkChileCompras.setText("ChileCompra");
        chkChileCompras.setEnabled(false);
        chkChileCompras.addMouseListener(new java.awt.event.MouseAdapter() {
            public void mouseClicked(java.awt.event.MouseEvent evt) {
                chkChileComprasMouseClicked(evt);
            }
        });

        chkEcona.setText("Econa");
        chkEcona.setEnabled(false);
        chkEcona.addMouseListener(new java.awt.event.MouseAdapter() {
            public void mouseClicked(java.awt.event.MouseEvent evt) {
                chkEconaMouseClicked(evt);
            }
        });
        chkEcona.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                chkEconaActionPerformed(evt);
            }
        });

        chkDisosur.setText("Disosur");
        chkDisosur.setEnabled(false);
        chkDisosur.addMouseListener(new java.awt.event.MouseAdapter() {
            public void mouseClicked(java.awt.event.MouseEvent evt) {
                chkDisosurMouseClicked(evt);
            }
        });
        ...
        lb2.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Iconos/Ok.png"))); // NOI18N
        lb2.setToolTipText("");

        lb1.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Iconos/Ok.png"))); // NOI18N
        lb1.setToolTipText("");

        lb3.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Iconos/Ok.png"))); // NOI18N
        lb3.setToolTipText("");

        lb4.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Iconos/Ok.png"))); // NOI18N
        lb4.setToolTipText("");
        ...
        jPanel4Layout.setHorizontalGroup(
            ...
            .addGroup(jPanel4Layout.createSequentialGroup()
                ...
                .addGroup(jPanel4Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING, false)
                    ...
                    .addComponent(chkDisosur, javax.swing.GroupLayout.Alignment.LEADING, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
                    .addComponent(chkChileCompras, javax.swing.GroupLayout.Alignment.LEADING, javax.swing.GroupLayout.DEFAULT_SIZE, 95, Short.MAX_VALUE)
                    .addComponent(chkEcona, javax.swing.GroupLayout.Alignment.LEADING, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE))
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
        ...
        jPanel4Layout.setVerticalGroup(
            ...
            .addGroup(jPanel4Layout.createSequentialGroup()
                ...
                .addGroup(jPanel4Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING)
                    .addComponent(lb1)
                    .addComponent(chkChileCompras))
                .addGap(17, 17, 17)
                .addGroup(jPanel4Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addComponent(chkEcona)
                    .addComponent(lb2))
                .addGap(17, 17, 17)
                .addGroup(jPanel4Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
        ...
        buttonGroup1.add(chkCajero);
        chkCajero.setText("Cajero SALA");
        ...
        chkVendedor.setText("Vendedor SALA");

        buttonGroup1.add(chkNoAsigna);
        chkNoAsigna.setSelected(true);
        chkNoAsigna.setText("Sin Asignacion SALA");
        chkNoAsigna.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                chkNoAsignaActionPerformed(evt);
            }
        });
        ...
        jPanel5Layout.setHorizontalGroup(
            ...
            .addGroup(jPanel5Layout.createSequentialGroup()
                ...
                .addGroup(jPanel5Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addComponent(chkVendedor, javax.swing.GroupLayout.PREFERRED_SIZE, 153, javax.swing.GroupLayout.PREFERRED_SIZE)
                    .addComponent(chkNoAsigna, javax.swing.GroupLayout.PREFERRED_SIZE, 153, javax.swing.GroupLayout.PREFERRED_SIZE))
        ...
        jPanel5Layout.setVerticalGroup(
            ...
            .addGroup(jPanel5Layout.createSequentialGroup()
                ...
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                .addComponent(chkNoAsigna, javax.swing.GroupLayout.PREFERRED_SIZE, 23, javax.swing.GroupLayout.PREFERRED_SIZE)
                .addContainerGap(javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE))
        );
...
//         Modificación: Cristian Ramírez   
        ...
        }else if (chkVendedor.isSelected()){
                
                    
            RolSala = 2;
                
        }else if (chkNoAsigna.isSelected()){
        ...
        try {
            ...
            if (Rs.next()) {
                ...
                if (lb1.isVisible()){
                    ...
                    chkChileCompras.setEnabled(true);
                ...
                Query2 = "update pacceso2 set administrador = '" +  ch_administrador.isSelected() + "', ajuste = '" + ch_ajuste.isSelected() + "', cobranza = '"  + ch_cobranza.isSelected() + "'," + 
                          "transformacion = '" +  ch_transformacion.isSelected() + "', gastos = '"  + ch_gastos.isSelected() + "', adminocp = '" + ch_adminocp.isSelected() + "', bodega = '"  + ch_bodega.isSelected() + "' \n" +
                          "where rut =" + txRut.getText().trim() +";";
                Sql2.ExeSql(Query2);
                Sql2.Commit();
                ...
                Query="insert into personal(rut, nombre, usuario, vendedor, apellidopaterno,\n" +
                      "apellidomaterno, direccion, poblacion, ciudad, celular, empresa,cajaactiva,activo)\n" +
                ...
                String Query4 = "insert into pacceso2( \n" +
                                "rut,\n" +
                                "administrador,\n" +
                                "ajuste,\n" +
                                "transformacion,\n" +
            ...
            Logger.getLogger(pfUsuarios_old.class.getName()).log(Level.SEVERE, null, e);
            Sql.Rollback();
            Sql2.Rollback();
        }
        finally {
    ...
    private void GrillaMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_GrillaMouseClicked
        ...
        try {
            ...
            Query2 ="SELECT p.rut, p.nombre,p.usuario,p.apellidopaterno paterno,p.apellidomaterno materno,\n" +
                    ...
                    "a.adminocp adminocp_acc,cc.ccosto ccosto_pcc,p.rut rut_pers, u.nivel, p.activo, u.separador, p.cajaactiva \n" +
                    "from personal p \n" +
    ...
    //****************************************************** SEPARACION  ******************************************************//            
                ...
                if (Rs1.getInt("cajaactiva") == 1){
                
                   chkCajero.setSelected(true);
                
                
                }if (Rs1.getInt("cajaactiva") == 2){
                
                   chkVendedor.setSelected(true);
                
                
                }if (Rs1.getInt("cajaactiva") == 0){
    ...
    //**************************************************************************************************************************************//            
                ...
                Query3="select separador from usuario where separador > 0";
                ...
                if (Sql3.GetRowCount() > 0){
                    ...
                    while (Rs3.next()){
                        ...
                        if (Rs3.getInt("separador") == 1){
                        
                            chkChileCompras.setSelected(true);
                        
                        }
                        
                        if (Rs3.getInt("separador") == 2){  
                        
                            chkEcona.setSelected(true); 
                        
                        }
                        
                        if (Rs3.getInt("separador") == 3){
                        
                            chkDisosur.setSelected(true);
                        
                        }
                        
                        if (Rs3.getInt("separador") == 4){
    ...
    private void btEditarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btEditarActionPerformed
        ...
        }else if(!chkChileCompras.isSelected()){
        ...
        if (chkEcona.isSelected()){
        
            
            if (lb2.isVisible()){
            
                chkEcona.setEnabled(true);
            
            }
        
        }else if (!chkEcona.isSelected()){
...
//    }
    ...
    private void chkEconaActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_chkEconaActionPerformed
        // TODO add your handling code here:
    }//GEN-LAST:event_chkEconaActionPerformed

    private void chkGeneralMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_chkGeneralMouseClicked
        
        if (chkChileCompras.isEnabled()){
        
            chkChileCompras.setSelected(false);
        }    
        
        if (chkEcona.isEnabled()){
            chkEcona.setSelected(false);
        }    
        
        if (chkDisosur.isEnabled()){
            chkDisosur.setSelected(false);
        }
    ...
    private void chkDisosurMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_chkDisosurMouseClicked
    ...
    }//GEN-LAST:event_chkDisosurMouseClicked

    private void chkEconaMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_chkEconaMouseClicked
    ...
    }//GEN-LAST:event_chkEconaMouseClicked

    private void chkChileComprasMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_chkChileComprasMouseClicked
    ...
    }//GEN-LAST:event_chkChileComprasMouseClicked
    ...
    private void chkNoAsignaActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_chkNoAsignaActionPerformed
        // TODO add your handling code here:
    }//GEN-LAST:event_chkNoAsignaActionPerformed
    ...
    private javax.swing.JCheckBox chkChileCompras;
    private javax.swing.JCheckBox chkDisosur;
    private javax.swing.JCheckBox chkEcona;
    private javax.swing.JCheckBox chkGeneral;
    private javax.swing.JCheckBox chkNoAsigna;
