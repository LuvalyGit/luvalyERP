...
public class pfReportePagosPrv extends javax.swing.JPanel {
    ...
    private void initComponents() {
        ...
        lbSumSaldo = new javax.swing.JLabel();
        ...
        jPanel3Layout.setHorizontalGroup(
            ...
            .addGroup(jPanel3Layout.createSequentialGroup()
                ...
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.UNRELATED)
                .addGroup(jPanel3Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addComponent(btBuscar, javax.swing.GroupLayout.DEFAULT_SIZE, 88, Short.MAX_VALUE)
        ...
        if (Grilla.getColumnModel().getColumnCount() > 0) {
            ...
            Grilla.getColumnModel().getColumn(2).setMinWidth(340);
            Grilla.getColumnModel().getColumn(2).setPreferredWidth(340);
            Grilla.getColumnModel().getColumn(2).setMaxWidth(340);
            ...
            Grilla.getColumnModel().getColumn(11).setMinWidth(100);
            Grilla.getColumnModel().getColumn(11).setPreferredWidth(100);
            Grilla.getColumnModel().getColumn(11).setMaxWidth(100);
            Grilla.getColumnModel().getColumn(12).setMinWidth(130);
            Grilla.getColumnModel().getColumn(12).setPreferredWidth(130);
            Grilla.getColumnModel().getColumn(12).setMaxWidth(130);
        ...
        jPanel4Layout.setHorizontalGroup(
            ...
            .addGroup(jPanel4Layout.createSequentialGroup()
                ...
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                .addComponent(lbPagosOtros, javax.swing.GroupLayout.PREFERRED_SIZE, 83, javax.swing.GroupLayout.PREFERRED_SIZE)
                .addGap(44, 44, 44)
                ...
                .addGroup(jPanel4Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addGroup(jPanel4Layout.createSequentialGroup()
                        ...
                        .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                        .addComponent(lbSumSaldo, javax.swing.GroupLayout.PREFERRED_SIZE, 109, javax.swing.GroupLayout.PREFERRED_SIZE))
                    .addGroup(jPanel4Layout.createSequentialGroup()
                        .addComponent(jLabel9)
                        .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                        .addComponent(lbSumDeuda, javax.swing.GroupLayout.PREFERRED_SIZE, 109, javax.swing.GroupLayout.PREFERRED_SIZE)
                        .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
    ...
    public void buscar(String StrRut){
        ...
        BigInteger TotalDeuda           = new BigInteger("0");
        BigInteger PagosOtros           = new BigInteger("0");
        BigInteger TotalSaldos          = new BigInteger("0");
...
//                    "fp.tipdocto,fp.nrodocto,case fp.tipdocto when 'FAP' then (select * from fn_get_proveedor_asociado(p.rut,fp.nrodocto)) else p.nombre end as prv_asociado, fp.femision,pp.nrocuota || ' de ' || fp.cuotas as cuotas,\n" +
                    "fp.tipdocto,fp.nrodocto, fp.femision,pp.nrocuota || ' de ' || fp.cuotas as cuotas,\n" +
            ...
            if(rbEstadoPendientes.isSelected()){
                Query = Query + "Where pp.fpago < current_date and pp.estado in (0,2) and pp.tipdocto NOT IN ('REM','PRV','FIN','PRE','PRM','NCP') \n"
                              + "and fp.tipdocto IS NOT NULL \n";
                
            }
            else if(rbEstadoVigentes.isSelected())
               Query = Query + "Where pp.estado in (0,2) and pp.fpago>= current_date and pp.tipdocto NOT IN ('REM','PRV','FIN','PRE','PRM','NCP') \n"
                             + "and fp.tipdocto IS NOT NULL \n";
             
            else if(rbEstadoPagadas.isSelected())
                Query = Query + "Where pp.estado=1 and pp.tipdocto NOT IN ('REM','PRV','FIN','PRE','PRM','NCP') \n"
                              + "and fp.tipdocto IS NOT NULL \n";
                
            
            else
              Query = Query + "Where pp.estado >=0 and pp.tipdocto NOT IN ('REM','PRV','FIN','PRE','PRM','NCP') \n"
                            + "and fp.tipdocto IS NOT NULL \n";
         ...
         //Fechas de vencimiento
            ...
            if (!txFiltro.getText().trim().isEmpty()){
            
                
                Query = Query + " and pp.nrodocto IN ('" + txFiltro.getText().trim()+"')";
            ...
            while(Rs.next()){
                ...
                if(!rbEstadoPagadas.isSelected()){
                    ...
                    switch(Rs.getInt("codpago")){
                        case 2:     //PagosTransferencia = PagosTransferencia.add(new BigInteger(Rs.getString("saldo"))) ;
                                    PagosTransferencia = PagosTransferencia.add(new BigInteger(Rs.getString("pagado"))) ;
                                    break;
                        case 3:     //PagosCheques = PagosCheques.add(new BigInteger(Rs.getString("saldo"))) ;
                                    PagosCheques = PagosCheques.add(new BigInteger(Rs.getString("pagado"))) ;
                                    break;
                        default:    //PagosOtros = PagosOtros.add(new BigInteger(Rs.getString("saldo"))) ;
                                    PagosOtros = PagosOtros.add(new BigInteger(Rs.getString("pagado"))) ;
                    }
                }else{
                ...
                TotalDeuda = TotalDeuda.add(new BigInteger(Rs.getString("monto"))) ;
                
                TotalSaldos = TotalSaldos.add(new BigInteger(Rs.getString("saldo"))) ;
...
//            String[] valores = new String[];
            ...
            lbSumDeuda.setText(fmMain.FormatoNumeroBig(TotalDeuda));
            ...
            lbSumSaldo.setText(fmMain.FormatoNumeroBig(TotalSaldos));
    ...
    private void txFiltroKeyReleased(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_txFiltroKeyReleased
        ...
        int row = Grilla.getRowCount();
            ...
            for(int i = 0; i < row; i++){
                ...
                TipoPago = Grilla.getValueAt(i, 12).toString().trim();
                
                if (TipoPago.trim().equals("CHEQUE")){
                
                    PagosCheques = PagosCheques.add(new BigInteger(Grilla.getValueAt(i, 10).toString().replace(",", "")));
                    
                
                }else if (TipoPago.trim().equals("TRANSFERENCIA")) {
                
                    
                    PagosTransferencia = PagosTransferencia.add(new BigInteger(Grilla.getValueAt(i, 10).toString().replace(",", "")));
                    
                
                }else{
                
                    PagosOtros = PagosOtros.add(new BigInteger(Grilla.getValueAt(i, 10).toString().replace(",", "")));
                    
                } 
               
                
                TotalPagos = TotalPagos.add(new BigInteger(Grilla.getValueAt(i, 10).toString().replace(",", "")));
                
                TotalDeuda = TotalDeuda.add(new BigInteger(Grilla.getValueAt(i, 9).toString().replace(",", "")));
                
                TotalSaldos = TotalSaldos.add(new BigInteger(Grilla.getValueAt(i, 11).toString().replace(",", "")));
     ...
     //     lbSumFiltro.setText((fmMain.FormatoNumeroBig(BigInteger.valueOf(sum))));
            ...
            lbPagoCheques.setText(fmMain.FormatoNumeroBig(PagosCheques));         // Columna 10
            lbPagosTrans.setText(fmMain.FormatoNumeroBig(PagosTransferencia));   //  Columna 10
            lbPagosOtros.setText(fmMain.FormatoNumeroBig(PagosOtros));          //   Columna 10
            lbSumMontos.setText(fmMain.FormatoNumeroBig(TotalPagos));           // Columna 10
            lbSumDeuda.setText(fmMain.FormatoNumeroBig(TotalDeuda));            // Columna 9
            lbSumSaldo.setText(fmMain.FormatoNumeroBig(TotalSaldos));           //Columna 11
...
//6700
    ...
    private javax.swing.JLabel lbSumSaldo;
