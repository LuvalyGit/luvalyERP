...
public class pfPrv_CargosRecibidos extends javax.swing.JPanel {
    ...
    private void initComponents() {
        ...
        jPanel5Layout.setHorizontalGroup(
            ...
            .addGroup(jPanel5Layout.createSequentialGroup()
                ...
                .addGroup(jPanel5Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                    ...
                    .addComponent(cbCuenta, 0, 357, Short.MAX_VALUE)
            ...
            .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, jPanel5Layout.createSequentialGroup()
                ...
                .addGroup(jPanel5Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addGroup(jPanel5Layout.createSequentialGroup()
                        ...
                        .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.UNRELATED)
                        .addComponent(btCargaCartola, javax.swing.GroupLayout.PREFERRED_SIZE, 196, javax.swing.GroupLayout.PREFERRED_SIZE))
        ...
        jPanel1Layout.setHorizontalGroup(
            ...
            .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, jPanel1Layout.createSequentialGroup()
                ...
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING, false)
                    ...
                    .addComponent(jPanel5, javax.swing.GroupLayout.Alignment.LEADING, javax.swing.GroupLayout.PREFERRED_SIZE, 448, javax.swing.GroupLayout.PREFERRED_SIZE))
                .addContainerGap())
        );
        ...
        if (GrillaMovimientos.getColumnModel().getColumnCount() > 0) {
            ...
            GrillaMovimientos.getColumnModel().getColumn(0).setPreferredWidth(80);
            ...
            GrillaMovimientos.getColumnModel().getColumn(3).setPreferredWidth(450);
            GrillaMovimientos.getColumnModel().getColumn(4).setPreferredWidth(105);
        ...
        jPanel3Layout.setHorizontalGroup(
            ...
            .addGroup(jPanel3Layout.createSequentialGroup()
                ...
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.UNRELATED)
                .addComponent(txFiltro, javax.swing.GroupLayout.PREFERRED_SIZE, 222, javax.swing.GroupLayout.PREFERRED_SIZE)
                .addGap(45, 45, 45))
            .addGroup(jPanel3Layout.createSequentialGroup()
    ...
    private void CargaBancos(){
        ...
        try {
            ...
            cbBancoId.addItem("2000");
            cbBanco.addItem("COMISIONES Y OTROS");
...
//            cbBancoId.setSelectedIndex(-1);      
    ...
    private void CargaCuentas(){
        ...
        if(!cbBanco.getItemAt(cbBanco.getSelectedIndex()).toString().trim().equals("LUVALY") &&
            !cbBanco.getItemAt(cbBanco.getSelectedIndex()).toString().trim().equals("COMISIONES Y OTROS")    ) {
    ...
    //                btBuscar.setEnabled(false);
        ...
        }else  if(cbBanco.getItemAt(cbBanco.getSelectedIndex()).toString().trim().equals("LUVALY")) {
    ...
    private void btCargaCartolaActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btCargaCartolaActionPerformed
        ...
        if(!cbBanco.getItemAt(cbBanco.getSelectedIndex()).toString().trim().equals("LUVALY") &&
           !cbBanco.getItemAt(cbBanco.getSelectedIndex()).toString().trim().equals("COMISIONES Y OTROS")    ) {   //BCI
            ...
            Modelo.setSelectionMode(ListSelectionModel.SINGLE_SELECTION);
                    
            GrillaCartola.setSelectionModel(Modelo);
        ...
        }else if(cbBanco.getItemAt(cbBanco.getSelectedIndex()).toString().trim().equals("LUVALY")) {   //LUVALY
            ...
            if(!txtDocumento.getText().equals("")) {
        ...
        }else if(cbBanco.getItemAt(cbBanco.getSelectedIndex()).toString().trim().equals("COMISIONES Y OTROS")) {   //COMISIONES BANCARIAS Y MERCADO LIBRE
                ...
                try {
                    ...
                    DefaultListSelectionModel Modelo = new DefaultListSelectionModel();
                    Modelo.setSelectionMode(ListSelectionModel.MULTIPLE_INTERVAL_SELECTION);
                   ...
                   String Query="SELECT cp.*, cxc.tipdocto, cxc.nrodocto from cli_pagos cp \n" +
                                "LEFT JOIN cli_cuentasxcobrar cxc ON cp.cuenta = cxc.id\n" +
                                "WHERE cp.tipopago IN ('300','400','500') \n";
                                                               
                    boolean conciliada = false; 
                   
                    if(cbConciliacion.getSelectedIndex()==0){
                        
                        Query = Query + "and cp.comision = 1  \n";
                        conciliada = false;
                        
                    }else if(cbConciliacion.getSelectedIndex()==1){
                    
                        Query = Query + "and cp.comision = 2 \n";
                        conciliada = true;
                    }
                    ...
                    while(Rs.next()){
                        ...
                        if (Rs.getString("tipopago").equals("300")){
                        
                            descripcion = "COMISION BANCARIA";
                        
                        }else if (Rs.getString("tipopago").equals("400")) {
                        
                            descripcion = "COMISION MERCADOLIBRE";
                        
                        }else if (Rs.getString("tipopago").equals("500")) {

                            
                            descripcion = "FLETE MERCADOLIBRE";
                        
                        }
                        
                        if (Rs.getString("tipdocto").equals("BOC")){
                        
                            documento = "Boleta N° : "+Rs.getString("nrodocto")+"  ";
                        
                        }else if (Rs.getString("tipdocto").equals("FAC")) {
                        
                            documento = "Factura N° : "+Rs.getString("nrodocto")+"  ";
                        
                        }
                        
                        
                        if (Rs.getString("comision").equals("1")){
                                                    
                            conciliada = false;
                           
                        
                        }else if (Rs.getString("comision").equals("2")) {
    ...
    private void btConciliarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btConciliarActionPerformed
        ...
        if(!cbBanco.getItemAt(cbBanco.getSelectedIndex()).toString().trim().equals("LUVALY") &&
           !cbBanco.getItemAt(cbBanco.getSelectedIndex()).toString().trim().equals("COMISIONES Y OTROS")){    //Si no es Luvaly
            ...
            for(int j = 0; j < seleccionados; j++){
                ...
                if(disponible >= montos[j]){          /**Si lo disponible puede cubrir el monto**/
                    ...
                    try {  
                        ...
                        if (GrillaCartola.getValueAt(GrillaCartola.getSelectedRow(), 3).toString().trim().contains("CHEQUE")){
                    ...
                    if(JOptionPane.showConfirmDialog(null,"Desea abonar "+disponible+" a documento: "+detalles[j]+"?")==0) {/**Si aún tiene disponible pero no cubre el monto**/
                        ...
                        try {
                            ...
                            resultado = resultado + Sql.ExeSqlInt("insert into prv_pagos\n" +
                                                                  "(cuenta,tipopago,banco,monto,nrodocumento,fechapago, id_cartola)\n" +
                                                                  "values\n" +
                                                                  "("+ GrillaMovimientos.getValueAt(filasSelec[j], 5).toString() +",'"+ pago +"', 1," + disponible +","
                                                                     + GrillaCartola.getValueAt(GrillaCartola.getSelectedRow(), 2).toString().trim()+""
                                                                     +",'" + GrillaCartola.getValueAt(GrillaCartola.getSelectedRow(), 0).toString().trim() + "','"
                                                                     + GrillaCartola.getValueAt(GrillaCartola.getSelectedRow(), 7).toString().trim() + "')");
...
//                    txNroDoct.setText("");
        ...
        }else if(cbBanco.getItemAt(cbBanco.getSelectedIndex()).toString().trim().equals("LUVALY")){    // Si se selecciona LUVALY    //**************************************************************************************************
        ...
        }else if(cbBanco.getItemAt(cbBanco.getSelectedIndex()).toString().trim().equals("COMISIONES Y OTROS")){   // Si se selecciona COMISIONES Y OTROS    //***************
            ...
            if(JOptionPane.showConfirmDialog(null, "¡Desea usar factura para abonar?")==0) {
                ...
                int cantidad = 0;
                int monto = Integer.valueOf(GrillaCartola.getValueAt(GrillaCartola.getSelectedRow(), 4).toString());
                int disponible = Integer.valueOf(GrillaCartola.getValueAt(GrillaCartola.getSelectedRow(), 4).toString());;
                int utilizado = Integer.valueOf(GrillaCartola.getValueAt(GrillaCartola.getSelectedRow(), 4).toString());;
                    ...
                    if(disponible >= montos[j]){     /***** Si lo disponible puede cubrir el monto *******/
                        ...
                        try {
                            ...
                            resultado += Sql.ExeSqlInt("insert into prv_pagos \n" +/**Pago**/
                                                       "(cuenta,tipopago,banco,monto,nrodocumento,fechapago, id_cartola)\n" +
                                                       "values\n" +
                                                        "("+ GrillaMovimientos.getValueAt(filasSelec[j], 5).toString() +",9 ,2000," + montos[j]
                                                      +",'" + GrillaCartola.getValueAt(GrillaCartola.getSelectedRow(), 2).toString().trim()+"'"
                                                      +",'" + GrillaCartola.getValueAt(GrillaCartola.getSelectedRow(), 0).toString().trim()
                                                      + "',"+0+")");
                            ...
                            Sql2.ExeSql("UPDATE cli_pagos set id_cartola = 2 \n"+
                                        "WHERE id=" + GrillaCartola.getValueAt(GrillaCartola.getSelectedRow(), 7).toString().trim());
                        ...
                        if(JOptionPane.showConfirmDialog(null,"Desea abonar "+disponible+" a documento: "+detalles[j]+"?")==0) {/**Si aún tiene disponible pero no cubre el monto**/
                            ...
                            try {
                                ...
                                resultado = resultado + Sql.ExeSqlInt("insert into prv_pagos\n" +
                                                                      "(cuenta,tipopago,banco,monto,nrodocumento,fechapago, id_cartola)\n" +
                                                                      "values\n" +
                                                                      "("+ GrillaMovimientos.getValueAt(filasSelec[j], 5).toString() +", 9, 2000," + disponible +",'"
                                                                         + GrillaCartola.getValueAt(GrillaCartola.getSelectedRow(), 2).toString().trim() +"','"
                                                                         + GrillaCartola.getValueAt(GrillaCartola.getSelectedRow(), 0).toString().trim() + "',"
                                                                         +0+ ")");
                                ...
                                Sql2.ExeSql("UPDATE cli_pagos set comision = 2 \n"+
                                            "WHERE id=" + GrillaCartola.getValueAt(GrillaCartola.getSelectedRow(), 7).toString().trim());
...
//                            "and p.monto between " + String.valueOf(Monto-Rango)+  "and " + String.valueOf(Monto+Rango));
            ...
            Rs = Sql.Select("select cxp.rut, cxp.id, \n" +
                            ...
                            "when cxp.tipdocto = 'FAG' then 'Gasto'\n" +
...
//        
    ...
    private void GrillaCartolaMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_GrillaCartolaMouseClicked
        ...
        if(!cbBanco.getItemAt(cbBanco.getSelectedIndex()).toString().trim().equals("COMISIONES Y OTROS")) {   //COMISIONES BANCARIAS Y MERCADO LIBRE
