    ...
    public void busca_pdfDoc(){
        ...
        try {
            ...
            Rs = Sql.Select("select c.*, cl.rut || '-' || cl.dv as rutcl from ctactecli c \n"+
                            ...
                            "where c.tipdocto='" + TipoNro +"' and c.nrodocto=" + TxNumero.getText().trim());
            ...
            if (Sql.GetRowCount() > 0){
                ...
                Numero=TipoNro+TxNumero.getText().trim()+".";
                ...
                if (encontrado == 1 && size > 0 ){
                    ...
                    if (ElRut.equals("11111111-1") && Tipo == 39){
                    ...
                    Imprimir2("76231391-K",ElRut,String.valueOf(Tipo),TxNumero.getText().trim(),Fecha,ElTotal,0,2,TipoNro);
...
//                              "&folio="+folio+"&fechaEmision="+fecha+"&montoTotal="+total);
            ...
            Logger.getLogger(pfBuscaDoc.class.getName()).log(Level.SEVERE, null, ex);
    ...
    public void busca_pdf(){
        ...
        try {
            ...
            System.out.println(TxNumero.getText().trim());
            Numero= Tipo+TxNumero.getText().trim();
