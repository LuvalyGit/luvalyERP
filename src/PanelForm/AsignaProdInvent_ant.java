 ...
 * @author luvaly
 */
public class AsignaProdInvent_ant extends javax.swing.JPanel {
...
//-----------------------------------------------------------------------------------------------
    ...
    private String  existe_sku(String Codigo){
        ...
        try{
            ...
            Query2 = "SELECT * FROM mt_productos_respaldo WHERE sku = '" + Codigo + "'";
            Rs1 = Sql.Select(Query2);
    ...
    private void agrega_linea(){
        ...
        if (pos >= 0){    // Si el codigo del prodcuto ya esta ingresado en la grilla modificara la cantidad ingresada
                ...
                try {
                   ...
                   Logger.getLogger(AsignaProdInvent_ant.class.getName()).log(Level.SEVERE, null, ex);
            ...
            {      
                ...
                qryIns = "INSERT INTO mt_productos_respaldo (ubicacion,sku,usuario,cant) \n" +
    ...
    //************************************************************ ACTUALIZA INVENTARIO ************************************************************//            
                ...
                String Qry4 = "SELECT * FROM inventario_respaldo \n "+
                               "WHERE sku= '" + txtSku.getText().trim() +"'";
                ...
                if(Sql4.GetRowCount()==0){                   //Si no existe el registro
                    ...
                    qryIns = "INSERT INTO inventario_respaldo (sku,stock) \n" +
                    ...
                    Sql2.ExeSql("UPDATE inventario_respaldo SET stock = stock + " +  Double.valueOf(fmMain.SetGuardar(txtCant.getText().trim())) + " \n" +
                                "WHERE sku = '" + Sku + "' ");
        ...
        try{ 
            ...
            for (int i=0; i<=Grilla_prod.getRowCount()-1; i++ ){
                ...
                if (Grilla_prod.getValueAt(i, 3).toString().trim()=="SI"){
                    ...
                    qryIns = "UPDATE mt_productos_respaldo SET cant = " +  Double.valueOf(fmMain.SetGuardar(Grilla_prod.getValueAt(i, 2).toString().trim())) + ", \n" +
          ...
          //********************************************************* ACTUALIZA INVENTARIO *******************************************************************//          
                   ...
                   String Qry3 = "SELECT * FROM inventario_respaldo \n "+
                                  "WHERE sku= '" + Sku +"'";
                    ...
                    if(Sql3.GetRowCount()==0){                   //Si no existe el registro en inventario
                        ...
                        Sql4.ExeSql("UPDATE inventario_respaldo SET stock = stock + " +  Double.valueOf(fmMain.SetGuardar(txtCant.getText().trim())) + " \n" +
                                    "WHERE sku = '" + Sku + "' ");
...
//        }
    ...
    private void btEliminar_lineaActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btEliminar_lineaActionPerformed
        ...
        try{
            ...
            Query2= "SELECT * FROM mt_productos_respaldo WHERE ubicacion ='" + strUbicacion + "' AND sku = '" + SKU + "'";
            Rs1 = Sql.Select(Query2);
            
            if (Rs1.next()){          // Elimina el registro Seleccionado
            
                qryDel = "DELETE FROM mt_productos_respaldo WHERE ubicacion ='" + strUbicacion + "' AND sku = '" + SKU + "'";
                Sql.ExeSql(qryDel);
                
                Sql2.ExeSql("UPDATE inventario_respaldo SET \n"+
    ...
    private void btEliminarTodoActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btEliminarTodoActionPerformed
        ...
        try{
            ...
            Query2= "SELECT * FROM mt_productos_respaldo WHERE ubicacion ='" + strUbicacion + "';";
            Rs1 = Sql.Select(Query2);
            
            if (Rs1.next()){  // Elimina el registro Seleccionado
                   
                    qryDel = "DELETE FROM mt_productos_respaldo WHERE ubicacion ='" + strUbicacion + "';";
                    Sql.ExeSql(qryDel);
                    Sql.Commit();
    ...
    private void btAutoActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btAutoActionPerformed
        ...
        try {
            ...
            if (Sql3.GetRowCount() > 0){
                ...
                Sql4.ExeSql("INSERT INTO autoriza_mt_productos (ubicacion,sku) \n" +
    ...
    public void CargaProducto(String Codigo) {
        ...
        try {
            ...
            Query ="SELECT p.sku,p.nombre,p.estado_codigo,u.unidad,p.convenio \n"+ 
                   "FROM producto p \n"+
                   "LEFT JOIN inventario_respaldo i \n"+
                   "ON p.sku = i.Sku \n"+
                   "LEFT JOIN par_unidad u ON  u.codigo = p.unidad \n"+
