...
//            " where b.codigo='" + ubicaArray[0] + "' and r.codigo= " + ubicaArray[1] +  " and m.codigo= " + ubicaArray[2] + "  and m.rack=" + ubicaArray[1];
    ...
    private void btNuevoActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btNuevoActionPerformed
        ...
        if(fmMain.OkCancel("¿Esta seguro de crear un nuevo folio?") == JOptionPane.OK_OPTION){
            ...
            txEstado.setText("Abierto"); // Estado Abierto
    ...
    private void Carga_Prod_Ubicacion_Folio(String ubicacion, int  llamado, String  folio ){
        ...
        try {
           ...
           else    
           {
            ...
            while(Rs.next()){
                dfTm.addRow(new Object[]{Rs.getString("Sku"),Rs.getString("Nombre"),Rs.getDouble("cant"),"NO","0",Rs.getString("unidad"),Rs.getString("fechita"),Rs.getString("ubicametro"),Rs.getString("ubicacion"),Rs.getDouble("cant_metro"),Rs.getDouble("cant")-Rs.getDouble("cant_metro")});
...
//                  txNombreUbica.setEditable(true);
                ...
                dfTm.addRow(new Object[]{Rs.getString("Sku"),Rs.getString("Nombre"),Rs.getDouble("cant"),"NO","0",Rs.getString("unidad"),Rs.getString("fechita"),Rs.getString("ubicametro"),Rs.getString("ubicacion"),Rs.getDouble("cant_metro"),Rs.getDouble("dif")});
