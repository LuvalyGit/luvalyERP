...
private void Sumador(){    
    ...
    for(int i=0; i< Grilla.getRowCount(); i++){
        ...
        Unitario = Grilla.getModel().getValueAt(i,GetCol("Unitario")).toString();
...
//                           txDias.getText().trim() + "')" );
            ...
            AbrirOCP(NewCorrelativo);
             ...
             Logger.getLogger(pfCCCotizaCliente.class.getName()).log(Level.SEVERE, null, e);
    ...
    private void btImprimirActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btImprimirActionPerformed
        ...
        String Query ="";
         Query = "select lower(p.usuario)   as nombre\n" +
            ...
            " where p.vendedor >0 and u.activo = true";
