 ...
 */
public class pfTransformacion extends javax.swing.JPanel {

    /**
     * Creates new form pfTransformacion
     */
    public pfTransformacion() {
        initComponents();
        txSku.requestFocus();
    }
    ...
    private void initComponents() {
        ...
        jPanel2Layout.setHorizontalGroup(
            ...
            .addGroup(jPanel2Layout.createSequentialGroup()
                ...
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                .addComponent(btTransformar, javax.swing.GroupLayout.PREFERRED_SIZE, 107, javax.swing.GroupLayout.PREFERRED_SIZE)
                .addContainerGap(javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE))
        );
    ...
    private void btTransformarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btTransformarActionPerformed
        ...
        double Cant=Double.valueOf(txCantidad.getText());
        double Factor,Stock,cant_transito;
        String Aux;
        boolean Alcanza=true, Transito = true;
        ...
        try{
            ...
            for(int i=0;i<GrillaRelacion.getRowCount(); i++){
                ...
                if(Total > Stock){     
                    ...
                    Alcanza=false;
                    fmMain.Mensaje("Stock= " + Stock +  "  NECESARIAS:" + Factor*Cant + "  SKU = " + GrillaRelacion.getValueAt(i,0).toString());
                
                }
                
                // Valida las cantidades de Transito
                Query = "select sku,cant from mt_productos where sku = '" + GrillaRelacion.getValueAt(i,0).toString() +"'" +
                        "and ubicacion = 'TRAN.1005.1'";
                ...
                if (Sql.GetRowCount() > 0){
                    ...
                    Rs1.next();
                    cant_transito=Rs1.getDouble("cant");
                         
                    if(Factor*Cant > cant_transito){
                         
                        Transito = false;
                        fmMain.Mensaje("TRANSITO= " + cant_transito +  "  NECESARIAS:" + Factor*Cant + "  SKU = " + Rs1.getString("sku")  );
                 
                    }        
                
                }else{
                
                    fmMain.Mensaje("Deben estar todos los codigos de partes en la ubicación TRANSITO  para transformar." + " \n SKU = " + GrillaRelacion.getValueAt(i,0).toString() );
                    return;
                }
            ...
            Logger.getLogger(pfTransformacion.class.getName()).log(Level.SEVERE, null, e);
        ...
        if(Alcanza == false){
           ...
           fmMain.Mensaje("El Stock no es suficiente para hacer la transformación.");
           return;
            
        }else if(Transito  == false){
         
           fmMain.Mensaje("El Stock de la ubicacion de Transito no es suficiente para hacer la transformación.");
           return;
        
        }else if(fmMain.OkCancel("¿Desea realizar la transformación?")== JOptionPane.OK_OPTION){
           
             System.out.println("Alcanza ES : "+Alcanza);
            
                try {
                    Sql1.ExeSql("select * from  fn_transformacion('"+ txSku.getText().trim() +"',"+ txCantidad.getText() +")");
                    Sql1.Commit();
                    fmMain.Mensaje("Transformado");
                    
                    actualiza_venta_web(txSku.getText().trim());
    ...
    private void actualiza_venta_web (String Sku){
        ...
        try{
                ...
                cost_vent_neto2 = Math.round((cost_ref/0.65*1.19));
                 ...
                 Sql2.ExeSql("UPDATE producto SET\n" +
                             "pventa_web = " +cost_vent_neto2  + ", \n" +
                             "pventa_web2 = " +cost_vent_neto2  + "\n" +
                             "WHERE sku = '" + Sku + "'\n");
                Sql2.Commit();
