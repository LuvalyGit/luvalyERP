...
import Dialogos.jdBuscaUbicacion2;
...
//        Grilla_prod.getColumnModel().getColumn(2).setCellRenderer(rightRenderer);
        ...
        btCodEsp.setVisible(false);
//        cbAutoriza.setVisible(false);   
//        pnAutoriza.setVisible(false);   
//        
        
//        if (intNivelUsuario==100){              //Se Valida si usuario no es nivel 100
        
            cbAutoriza.setVisible(true);         //se desactiva botón
            pnAutoriza.setVisible(true);   
//        }
    ...
    private void initComponents() {
        ...
        cbAutoriza = new javax.swing.JButton();
        pnAutoriza = new javax.swing.JPanel();
        ...
        cbAutoriza.setFont(new java.awt.Font("Tahoma", 1, 11)); // NOI18N
        cbAutoriza.setForeground(new java.awt.Color(51, 153, 0));
        cbAutoriza.setText("AUTORIZACION");
        cbAutoriza.setToolTipText("");
        ...
        pnAutoriza.setBorder(javax.swing.BorderFactory.createEtchedBorder());

        jLabel4.setText("Clave Autorización");

        lbCodigo.setText("Sku");
        ...
        javax.swing.GroupLayout pnAutorizaLayout = new javax.swing.GroupLayout(pnAutoriza);
        pnAutoriza.setLayout(pnAutorizaLayout);
        pnAutorizaLayout.setHorizontalGroup(
            pnAutorizaLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
            .addGroup(pnAutorizaLayout.createSequentialGroup()
                .addContainerGap()
                .addGroup(pnAutorizaLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addGroup(pnAutorizaLayout.createSequentialGroup()
                        .addComponent(lbCodigo, javax.swing.GroupLayout.PREFERRED_SIZE, 50, javax.swing.GroupLayout.PREFERRED_SIZE)
                        .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.UNRELATED)
                        .addComponent(txCodigo, javax.swing.GroupLayout.PREFERRED_SIZE, 117, javax.swing.GroupLayout.PREFERRED_SIZE))
                    .addGroup(pnAutorizaLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING, false)
                        .addGroup(pnAutorizaLayout.createSequentialGroup()
                            .addGap(10, 10, 10)
                            .addComponent(btAuto, javax.swing.GroupLayout.PREFERRED_SIZE, 85, javax.swing.GroupLayout.PREFERRED_SIZE)
                        ...
                        .addGroup(pnAutorizaLayout.createSequentialGroup()
                            ...
                            .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.UNRELATED)
                            .addComponent(txClave, javax.swing.GroupLayout.PREFERRED_SIZE, 96, javax.swing.GroupLayout.PREFERRED_SIZE))))
                .addGap(23, 23, 23))
        );
        pnAutorizaLayout.setVerticalGroup(
            pnAutorizaLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
            .addGroup(pnAutorizaLayout.createSequentialGroup()
                .addContainerGap()
                .addGroup(pnAutorizaLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                ...
                .addGroup(pnAutorizaLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                    .addComponent(btAuto, javax.swing.GroupLayout.PREFERRED_SIZE, 42, javax.swing.GroupLayout.PREFERRED_SIZE)
                            ...
                            .addGroup(jPanelHastaLayout.createSequentialGroup()
                                .addGroup(jPanelHastaLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                                    .addGroup(jPanelHastaLayout.createSequentialGroup()
                                        ...
                                        .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                                        .addComponent(txNombre, javax.swing.GroupLayout.PREFERRED_SIZE, 565, javax.swing.GroupLayout.PREFERRED_SIZE))
                                    .addGroup(jPanelHastaLayout.createSequentialGroup()
                                        .addGroup(jPanelHastaLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                                            .addGroup(jPanelHastaLayout.createSequentialGroup()
                                ...
                                .addGap(28, 28, 28)
                                .addComponent(pnAutoriza, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE))
                            .addGroup(jPanelHastaLayout.createSequentialGroup()
                                .addGroup(jPanelHastaLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                                    .addGroup(jPanelHastaLayout.createSequentialGroup()
                                    ...
                                    .addGroup(jPanelHastaLayout.createSequentialGroup()
                                        .addComponent(txNombreUbica, javax.swing.GroupLayout.PREFERRED_SIZE, 648, javax.swing.GroupLayout.PREFERRED_SIZE)
                                        .addGap(28, 28, 28)
                                        .addComponent(cbAutoriza, javax.swing.GroupLayout.PREFERRED_SIZE, 131, javax.swing.GroupLayout.PREFERRED_SIZE)))
                                .addGap(51, 51, 51)
        ...
        jPanelHastaLayout.setVerticalGroup(
            ...
            .addGroup(jPanelHastaLayout.createSequentialGroup()
                .addGroup(jPanelHastaLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, jPanelHastaLayout.createSequentialGroup()
                        .addComponent(cbAutoriza, javax.swing.GroupLayout.PREFERRED_SIZE, 44, javax.swing.GroupLayout.PREFERRED_SIZE)
                        .addGap(146, 146, 146))
                    .addGroup(jPanelHastaLayout.createSequentialGroup()
                        .addGroup(jPanelHastaLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            .addGroup(jPanelHastaLayout.createSequentialGroup()
                                                ...
                                                .addGroup(jPanelHastaLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                                                    .addGroup(jPanelHastaLayout.createSequentialGroup()
                                                        .addGroup(jPanelHastaLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING)
                                                            .addComponent(rbAutoma, javax.swing.GroupLayout.PREFERRED_SIZE, 32, javax.swing.GroupLayout.PREFERRED_SIZE)
...
//-----------------------------------------------------------------------------------------------
    ...
    private void agrega_linea(){
        ...
        ResultSet Rs4;
        String qryIns,Sku,Ubicacion,StUsuario ;
        Ubicacion ="";
        ...
        if (pos >= 0){    // Si el codigo del producto ya esta ingresado en la grilla modificara la cantidad ingresada
    ...
    //************************************************************ ACTUALIZA INVENTARIO ************************************************************//            
                ...
                String Qry4 = "SELECT * FROM inventario2024 \n "+
                ...
                if(Sql4.GetRowCount()==0){                   //Si no existe el registro
                    ...
                    qryIns = "INSERT INTO inventario2024 (sku,stock) \n" +
                    ...
                    Sql2.ExeSql("UPDATE inventario2024 SET stock = stock + " +  Double.valueOf(fmMain.SetGuardar(txtCant.getText().trim())) + " \n" +
                                "WHERE sku = '" + Sku + "' ");
...
//                    if (nombrePalabra.substring(0,3).trim().equals("LVL") || nombrePalabra.substring(0,4).trim().equals("TRAN") ||
//                        nombrePalabra.substring(0,4).trim().equals("SAL")){
        ...
        try{ 
            ...
            for (int i=0; i<=Grilla_prod.getRowCount()-1; i++ ){
                ...
                if (Grilla_prod.getValueAt(i, 3).toString().trim()=="SI"){
                    ...
                    qryIns = "UPDATE mt_productos2 SET cant = " +  Double.valueOf(fmMain.SetGuardar(Grilla_prod.getValueAt(i, 2).toString().trim())) + ", \n" +
                    ...
                    Sql2.ExeSql("update producto set estado_codigo= '"+ false +"' where sku ='" + Sku+ "'");   
                   
                    
          //********************************************************* ACTUALIZA INVENTARIO *******************************************************************//          
                    
                   String Qry3 = "SELECT * FROM inventario2024 \n "+
                                  "WHERE sku= '" + Sku.trim() +"'";
                            
                    Rs3 = Sql3.Select(Qry3);
                            
                    if(Sql3.GetRowCount()==0){                   //Si no existe el registro en inventario
                        ...
                        Sql4.ExeSql("UPDATE inventario2024 SET stock = stock + " +  Double.valueOf(fmMain.SetGuardar(txtCant.getText().trim())) + " \n" +
                                    "WHERE sku = '" + Sku + "' ");
...
//        }
    ...
    private void btEliminar_lineaActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btEliminar_lineaActionPerformed
        ...
        try{
            ...
            Query2= "SELECT * FROM mt_productos2 WHERE ubicacion ='" + strUbicacion.trim() + "' AND sku = '" + SKU + "'";
            Rs1 = Sql.Select(Query2);
            
            if (Rs1.next()){          // Elimina el registro Seleccionado
            
                qryDel = "DELETE FROM mt_productos2 WHERE ubicacion ='" + strUbicacion.trim() + "' AND sku = '" + SKU + "'";
                Sql.ExeSql(qryDel);
                
                Sql2.ExeSql("UPDATE inventario2024 SET \n"+
    ...
    private void btEliminarTodoActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btEliminarTodoActionPerformed
        ...
        try{
            ...
            Query2= "SELECT * FROM mt_productos2 WHERE ubicacion ='" + strUbicacion.trim() + "';";
            Rs1 = Sql.Select(Query2);
            
            if (Rs1.next()){  // Elimina el registro Seleccionado
                   
                    qryDel = "DELETE FROM mt_productos2 WHERE ubicacion ='" + strUbicacion.trim() + "';";
                    Sql.ExeSql(qryDel);
                    Sql.Commit();
    ...
    private void btUbicacionActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btUbicacionActionPerformed
        ...
        jdBuscaUbicacion2 Ubicacion= new jdBuscaUbicacion2(null, true);
    ...
    private void txClaveKeyPressed(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_txClaveKeyPressed
        ...
        if(evt.getKeyCode() == KeyEvent.VK_ENTER){
            ...
            if (txClave.getText().equals("lvl2022")){
                ...
                btCancelar.setEnabled(false);
                btAuto.setEnabled(false);
                fmMain.Mensaje("Clave Incorrecta !!");
                txClave.setText("");
                txClave.requestFocus();
    ...
    private void btAutoActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btAutoActionPerformed
        ...
        if (txCodigo.getText().isEmpty()){
            ...
            fmMain.Mensaje("Debe Ingresar un Código!!");
            txCodigo.requestFocus();
            return; 
        }
        ...
        try {
            ...
            Rs3 = Sql3.Select("SELECT * FROM producto WHERE sku='" + txCodigo.getText().trim() + "'" );    
            
            if (Sql3.GetRowCount() > 0){
            
                Sql2.ExeSql("update producto set estado_codigo= '"+ true +"' where sku ='" + txCodigo.getText().trim()+ "'");   
                Sql2.Commit();
                 
                
                Sql4.ExeSql("INSERT INTO autoriza_mt_productos2 (ubicacion,sku) \n" +
                            "VALUES ('" + txtUbicacion.getText().trim() + "','" + txCodigo.getText().trim() + "')");   
                Sql4.Commit();
                ...
                btCancelar.setEnabled(false);
                  ...
                  fmMain.Mensaje("Producto No existe o está mal ingresado!!"); 
                  txCodigo.setText("");
                  txCodigo.requestFocus();
                  return;
        ...
        try {
           ...
           while(Rs.next()){
                ...
                String qry = "SELECT p.sku AS Sku1,cc.sku AS cchile, tr.sku AS skut,tr.skurel\n" +
                             ...
                             "WHERE mp.ubicacion ='"+ubicacion.trim()+"' AND p.sku = '"+sku+"' AND mp.cant <> 0 AND p.sku IS NOT null \n" +
                             "ORDER BY p.sku\n";
                ...
                if (Sql2.GetRowCount() > 0){
                    ...
                    if(Rs2.getString("cchile") != null){   //Si el Sku de codchile no es nulo
                       
                        if (!Rs2.getString("Sku1").equals(SkuAnt)){        //Si no se repite el SKU
                           
                            SkuAnt = Rs2.getString("Sku1").trim();   //El nuevo Sku será el anterior en la siguiente iteración
                    ...
                    }else if(Rs2.getString("cchile") == null){      //Si el Sku de codchile es nulo
    ...
    private javax.swing.JButton cbAutoriza;
    ...
    private javax.swing.JPanel pnAutoriza;
