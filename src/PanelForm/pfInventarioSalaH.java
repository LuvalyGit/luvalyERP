...
import Dialogos.jdBuscaUbicacionSalaH;
 ...
 */
public class pfInventarioSalaH extends javax.swing.JPanel {
    ...
    public pfInventarioSalaH() {
        ...
        txtUbicacion.addAncestorListener(new AncestorListener() {   //Para que el cursor se posicione en el textfield al abrir
    ...
    private void CARGAR(){
        ...
        try {
            ...
            Query="SELECT tp.sku, p.nombre, tp.sistema FROM mt_inventario_salah tp \n" +
            ...
            System.out.println(e);
             Logger.getLogger(pfInventarioSalaH.class.getName()).log(Level.SEVERE, null, e);
...
//                        }
                        ...
                        if(!Rs.getString("nombre").trim().contains("SALATH") && !Rs.getString("nombre").trim().contains("PATIOTH")){
                        
                            fmMain.Mensaje("Ubicación No Corresponde!!"); 
                            txtUbicacion.setText("");
                            txNombreUbicacion.setText("");
                            txtUbicacion.requestFocus();
                            return;
    ...
    private void btUbcActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btUbcActionPerformed
       ...
       jdBuscaUbicacionSalaH Ubicacion= new jdBuscaUbicacionSalaH(null, true);
    ...
    private void btReubicarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btReubicarActionPerformed
        ...
        try{
            ...
            Reubicacion2();  //Descuenta las cantidades reubicadas de inventario_salath
        ...
        try {
            ...
            for (int i = 0; i < Grilla_Aud.getRowCount(); i++) {
                ...
                if(agrega && Cantidad > 0){
                    ...
                    Actualiza_Ubc_Destino(Cantidad, Ubica, Sku);  ////Agregar o actualiza las cantidades agregadas en la ubicacion de Destino desde Inventario SalaH
                    ...
                    //*********************************************************************************************************************//            
                        ...
                        String QryDel = "UPDATE mt_inventario_salah SET \n"+
                        ...
                        Grilla_Aud.setValueAt(Sistema, i, 2);   //actualiza stock Sistema despues de la reubicación
    ...
    private void Actualiza_Ubc_Destino(int Cantidad, String Ubica, String Sku){
        ...
        try {
            ...
            Sql2.Commit();
                ...
                Sql2.Rollback();
                Logger.getLogger(pfInventarioSalaH.class.getName()).log(Level.SEVERE, null, ex);
        ...
        try {
                ...
                if (Sql.GetRowCount() > 0){
                    ...
                    while (Rs.next()){
                        ...
                        }else if (cant >= Tot_cant &&  Tot_cant > 0) {
                ...
                if (Sistema < 0){
                    ...
                    DescuentaCantNegativas(Sku, Sistema); 
   ...
   private void DescuentaCantNegativas(String Sku, int Sistema){
       ...
       ExeSql Sql = new ExeSql();
        ...
        try {
                ...
                int Tot_cant = (Sistema*-1);//6995779
