        ...
        try {
           // Rs = Sql.Select("select * from pg_user where usename <> 'postgres'");
            ...
            while(Rs.next()){
                ...
                dfTm.addRow(new Object[]{Rs.getString("fecha_mod"),Rs.getString("usuario_mod"),Rs.getString("ubicacion"),Rs.getString("sku"),Rs.getString("nombre"), Rs.getDouble("cant"), Rs.getDouble("cant_metro"),Rs.getDouble("dif")});
                i++;
            }
