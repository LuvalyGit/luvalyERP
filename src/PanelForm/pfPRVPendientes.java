...
DefaultTableCellRenderer rightRenderer = new DefaultTableCellRenderer();
    ...
    private void initComponents() {
        ...
        Grilla.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "Rut", "Nombre", "Tipo", "Numero", "Emisión", "Recepción", "Orden", "Monto", "Ncp"
            }
        ) {
        ...
        try {
            ...
            while(Rs.next()){
                ...
                if (elige == 1 || elige == 2){
                    ...
                    QueryNcp = "select sum(ubicancp) as existe from ctacteprvdet \n" +
                                "where tipdocto IN ('OCP') and nrodocto ="+Orden;
                    
                    Rs2 = Sql2.Select(QueryNcp);
...
//            fmMain.Mensaje(e.getMessage());
    ...
    private void AbrirOrdenActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_AbrirOrdenActionPerformed
        ...
        String EsGuiaFac = Grilla.getValueAt(Grilla.getSelectedRow(), 2).toString().trim();
        
        if(EsGuiaFac.trim().equals("Guía") ||  EsGuiaFac.trim().equals("Factura")){
        
            pfOCProveedor PrvOC = new pfOCProveedor();
            PrvOC.AbrirOCP(Grilla.getValueAt(Grilla.getSelectedRow(), 6).toString().trim());
