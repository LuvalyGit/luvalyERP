...
public class pfAjusteStock extends javax.swing.JPanel {
    ...
    private void initComponents() {
        ...
        Grilla.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "Código", "Nombre", "Unidad", "Stock Actual", "Acción", "Cantidad", "Stock Final", "tipo", "NomUbica", "CodUbica", "Costo", "CostoTotal"
            }
        ) {
    ...
    private void cbMotivoActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_cbMotivoActionPerformed
        ...
        System.out.println("Nuevo ES : "+Nuevo);
...
//        }
        ...
        try{
            ...
            Rs = Sql.Select("SELECT sp_getcorrelativo FROM sp_getcorrelativo('AJU')");   
            Rs.next();
            ...
            if (cbMotivo.getSelectedIndex() == 1){   //Si es Merma
            
                txComentarios.setText("MERMA");
                
            }
            
            Sql.ExeSql( "INSERT INTO ajusteenc(folio,motivo,comentario) \n" +
                        "VALUES (\n" +
                        Folio + ",\n" +
            ...
            for(int i=0;i< Grilla.getRowCount();i++){
                ...
                Sql.ExeSql("INSERT INTO ajustedet(folio,sku,cantidad,tipo,costofinal) \n" +
                            "VALUES (\n" +
                            Folio + ",\n'" +
    ...
    private void cbTipoActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_cbTipoActionPerformed
        ...
        if (cbTipo.getSelectedItem() == "Restar" &&  Auditoria == 0 ){
            ...
            Query = "SELECT sku,cant FROM mt_productos WHERE ubicacion = '" + stCodUbica.trim() + "' \n" +
                    "AND sku  = '" + txSku.getText().trim() + "'";
...
//                         "AND m.codigo= " + ubicaArray[2] + " AND m.rack=" + ubicaArray[1];
    ...
    private void btCargarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btCargarActionPerformed
        ...
        Nomubica = "TRANSITO-MERMA";
              
        Query = "SELECT mtp.*, p.nombre,u.unidad,i.stock, p.valultcompra,mtp.ubicacion as Ubica \n"+
               ...
               // "WHERE mtp.ubicacion = '" + stCodUbica + "' \n"+
                "WHERE mtp.ubicacion IN ('TRAN.1009.1','TRAN.1009.2','TRAN.10009.1') \n"+
                "AND mtp.cant > 0";
        ...
        try{
            ...
            if(Sql.GetRowCount() > 0){
                ...
                while (Rs.next()){
                    ...
                    double ctotal = (Rs.getDouble("cant") * Rs.getDouble("valultcompra"));
                    ...
                    TableModel.addRow(new Object[]{Rs.getString("sku").trim(), 
                                                   ...
                                                   1,
                                                   Nomubica,
                                                   Rs.getString("Ubica").trim() ,
                                                   //stCodUbica,
                                                   fmMain.FormatoNumero(Rs.getDouble("valultcompra")),
...
//        }
    ...
    private void ExportarExcel(){
        ...
        String NomArchivo = "Ajuste_Merma";
    ...
    //************************************************************* AZUL **************************************************************//      
     ...
     //************************************************************* VERDE **************************************************************//      
            ...
            hoja.setColumnView(2, 15);     //Unidades
            hoja.setColumnView(3, 15);     //Stock Actual
            hoja.setColumnView(4, 15);     //Cantidad
            hoja.setColumnView(5, 15);     //Stock Final
            hoja.setColumnView(6, 15);     //Costo
            hoja.setColumnView(7, 15);     //Costo Total
    ...
    //********************************  Se agregan contenido a las celdas de la hoja  *******************************************        
            ...
            hoja.addCell(new jxl.write.Label(2,0,"Unidad",format));
            hoja.addCell(new jxl.write.Label(3,0,"Stock Actual",format));
            hoja.addCell(new jxl.write.Label(4,0,"Cantidad",format));
            hoja.addCell(new jxl.write.Label(5,0,"Stock Final",format));
            hoja.addCell(new jxl.write.Label(6,0,"Costo",format));
            hoja.addCell(new jxl.write.Label(7,0,"Costo Total",format));
            
            
            WritableCellFormat format1 = new WritableCellFormat();   
            format1.setAlignment(Alignment.RIGHT);
            format1.setBorder(Border.ALL, BorderLineStyle.THIN,Colour.BLACK); //table border style
            ...
            for(int i=0; i < Grilla.getRowCount(); i++){ //For                  //Se agregan filas con los datos
                ...
                hoja.addCell(new jxl.write.Label(2,fila,Grilla.getValueAt(i,2).toString(),format3));
                hoja.addCell(new jxl.write.Label(3,fila,Grilla.getValueAt(i,3).toString(),format2));
                hoja.addCell(new jxl.write.Label(4,fila,Grilla.getValueAt(i,5).toString(),format2));
                hoja.addCell(new jxl.write.Label(5,fila,Grilla.getValueAt(i,6).toString(),format2));
                hoja.addCell(new jxl.write.Number(6,fila,Double.parseDouble(Grilla.getValueAt(i,10).toString().trim().replaceAll("\\,", "")),format1));
                hoja.addCell(new jxl.write.Number(7,fila,Double.parseDouble(Grilla.getValueAt(i,11).toString().trim().replaceAll("\\,", "")),format1));
                
                total = total + Double.parseDouble(Grilla.getValueAt(i,11).toString().trim().replaceAll("\\,", ""));
            
            }
            
            hoja.addCell(new jxl.write.Label(7,fila+1,""));
            hoja.addCell(new jxl.write.Label(6,(fila+2),"TOTAL"));
            hoja.addCell(new jxl.write.Number(7,(fila+2),total));
    ...
    //***************************************************************************************************************************    
            ...
            Logger.getLogger(pfAjusteStock.class.getName()).log(Level.SEVERE, null, ex);
        }
    ...
    private void AbrirFolio(String Numero){
        ...
        try {
            ...
            Rs = Sql.Select("select d.sku,p.nombre,u.unidad,d.stockini,d.costofinal,\n" +
                            ...
                            "left join par_unidad u on p.unidad=u.codigo\n" +
                            "where d.folio=" + Numero+" ORDER BY p.nombre");
    ...
    private void CargaProducto(String Codigo){
        ...
        try {
            ...
            if (Auditoria == 1){
                ...
                Rs = Sql.Select("select p.sku,p.nombre,u.unidad,i.stock,diferencia,folio \n" +
                            "from producto p\n" +
                            "left join inventario i on p.sku=i.sku\n" +
                            "left join par_unidad u on p.unidad=u.codigo \n" +
                            "left join mt_auditoria_ubicaciones au on p.sku=au.sku \n" +
            ...
            if ( Rs.getRow()>0){
                ...
                Query = "select p.sku,pr.nombre, u.unidad, i.stock \n" +
                        "from codbar p\n" +
                        "left join producto pr on pr.sku = p.sku\n"+
                        "left join par_unidad u on pr.unidad=u.codigo\n"+
                        "left join inventario i on p.sku=i.sku\n"+
                        "where p.sku = (select sku from codbar where codbar = '"+ Codigo.trim()+"') limit 1";
                ...
                if (Rs1.getRow() > 0){
                    ...
                    Query = "select p.sku,pr.nombre, u.unidad, i.stock \n" +
                            ...
                            "left join par_unidad u on pr.unidad=u.codigo\n"+
                            "left join inventario i on p.sku=i.sku\n"+
                            "where p.sku = (select sku from codchile where idch = '"+ Codigo.trim()+"')";
                                  
                    Rsl2 = Sql.Select(Query);
                    Rsl2.next();
                        
                    if (Rsl2.getRow() > 0){
                            
                        txSku.setText(Rsl2.getString("sku"));
                        txNombre.setText(Rsl2.getString("nombre").trim());
                        txUnidad.setText(Rsl2.getString("unidad").trim());
                        txStockActual.setText(fmMain.FormatoNumero(Rsl2.getDouble("stock")));
                        cbTipo.requestFocus();
