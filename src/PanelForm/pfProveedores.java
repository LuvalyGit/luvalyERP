...
public class pfProveedores extends javax.swing.JPanel {
    ...
    private void initComponents() {
        ...
        txCompraMinima = new javax.swing.JTextField();
        jLabel14 = new javax.swing.JLabel();
        txDiasN = new javax.swing.JTextField();
        btNuevaCondicion2 = new javax.swing.JToggleButton();
        ...
        txtComuna.setFont(new java.awt.Font("Tahoma", 0, 10)); // NOI18N
                ...
                .addGroup(jPanel10Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING)
                    .addGroup(jPanel10Layout.createSequentialGroup()
                        ...
                        .addGroup(jPanel10Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            ...
                            .addGroup(jPanel10Layout.createSequentialGroup()
                                .addComponent(txtCiudad, javax.swing.GroupLayout.PREFERRED_SIZE, 271, javax.swing.GroupLayout.PREFERRED_SIZE)
                                .addGap(10, 10, 10)
                    ...
                    .addGroup(jPanel10Layout.createSequentialGroup()
                        ...
                        .addGroup(jPanel10Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING)
                            .addGroup(jPanel10Layout.createSequentialGroup()
                                ...
                                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                                .addComponent(cbRegion, javax.swing.GroupLayout.PREFERRED_SIZE, 271, javax.swing.GroupLayout.PREFERRED_SIZE))
                            .addGroup(jPanel10Layout.createSequentialGroup()
                                .addComponent(jLabel6)
                                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                                .addComponent(txtComuna, javax.swing.GroupLayout.PREFERRED_SIZE, 271, javax.swing.GroupLayout.PREFERRED_SIZE)))
                        .addGap(430, 430, 430)))
                .addContainerGap())
        );
        ...
        jPanel11.add(txDias, new org.netbeans.lib.awtextra.AbsoluteConstraints(398, 82, 50, -1));
        ...
        jPanel11.add(txCompraMinima, new org.netbeans.lib.awtextra.AbsoluteConstraints(398, 113, 90, -1));
        ...
        jPanel11.add(txDiasN, new org.netbeans.lib.awtextra.AbsoluteConstraints(590, 80, 50, 20));

        btNuevaCondicion2.setText("Nueva Condicion");
        btNuevaCondicion2.setEnabled(false);
        btNuevaCondicion2.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                btNuevaCondicion2ActionPerformed(evt);
            }
        });
        jPanel11.add(btNuevaCondicion2, new org.netbeans.lib.awtextra.AbsoluteConstraints(470, 80, -1, -1));
        ...
        jButton2.setText("Cargar ficha de productos");
        jButton2.setActionCommand("btnCargarFicha");
        ...
        jButton3.setText("Ver ficha de productos");
        jButton3.setActionCommand("btnVerFicha");
    ...
    private void Edicion(boolean Estado){
        ...
        txtComuna.setEditable(Estado);
        txtCiudad.setEditable(Estado);
...
//            if (fmMain.GetUsuario().toLowerCase().trim().equals("lrubilar") || fmMain.GetUsuario().toLowerCase().trim().equals("lerubilar") ||
//                fmMain.GetUsuario().toLowerCase().trim().equals("alopez")){
                ...
                txCompraMinima.setEnabled(Estado);
...
//            }
    ...
    private void txRutKeyPressed(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_txRutKeyPressed
        if (evt.getKeyCode() == KeyEvent.VK_ENTER && Tipo != 1) {
            ...
            BuscaExisteProveedor(txRut.getText().trim());
    ...
    private void btGuardarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btGuardarActionPerformed
        ...
        if(txDv.getText().isEmpty() || txNombre.getText().isEmpty() || txGiro.getText().isEmpty()){
        ...
        /*****************************************************************************************************************/
         ...
         if (chkCredito.isSelected()){
            ...
            if (nuevacond == 1){
                ...
                if (txDiasN.getText().trim().isEmpty()){
                    txDiasN.setText("0");
        
                }
        
        
                int dias = Integer.parseInt(txDias.getText().toString().trim());
               ...
               // if (!fmMain.GetUsuario().equals("ALOPEZ")){    
                    ...
                    if (diasn < dias){
                        ...
                        fmMain.Mensaje("Condicion de Pago no puede ser menor a la Actual!!!");
                        txDiasN.requestFocus();
                        return;
                ...
                txDias.setText(txDiasN.getText().trim());
        ...
        if(!txCuotas.getText().trim().isEmpty()) Cuotas=txCuotas.getText().trim();
        else Cuotas="0";
            
        if(!txDias.getText().trim().isEmpty())   Dias = txDias.getText().trim();
        else Dias = "0";
            
        if(!txCrAsignado.getText().trim().isEmpty())   Credito = txCrAsignado.getText().trim();
        else Credito = "0";          
        ...
        if(fmMain.OkCancel("¿Guardar los cambios realizados?")== JOptionPane.OK_OPTION){
            ...
            btNuevaCondicion2.setSelected(false);
            btNuevaCondicion2.setEnabled(false);
            txDiasN.setVisible(false);
            ...
            //Update PROVEEDOR  
                ...
                try {
                    ...
                    Logger.getLogger(pfProveedores.class.getName()).log(Level.SEVERE, null, e);
    ...
    private void btEditarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btEditarActionPerformed
        ...
        if(chkCredito.isSelected()){
            ...
            btNuevaCondicion2.setEnabled(true);
...
//        }
    ...
    private void txDiasNKeyPressed(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_txDiasNKeyPressed
...
//         }
    ...
    }//GEN-LAST:event_txDiasNKeyPressed

    private void btNuevaCondicion2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btNuevaCondicion2ActionPerformed
        
        
        if (btNuevaCondicion2.isSelected()){
        
            txDiasN.setVisible(true);
            txDiasN.setText("");
            txDiasN.requestFocus();
            nuevacond = 1;
        
        }else if (!btNuevaCondicion2.isSelected()) {
...
// Carga CLIENTES
//------------------------------------------------------------------------------
   public void BuscaExisteProveedor(String Rut){
       ...
       ResultSet Rs;
        ...
        try{
            ...
            if(Sql.GetRowCount() > 0){
               ...
               fmMain.Mensaje("Proveedor ya existe!!");
    ...
    private javax.swing.JToggleButton btNuevaCondicion2;
    ...
    private javax.swing.JTextField txCompraMinima;
    ...
    private javax.swing.JTextField txDiasN;
