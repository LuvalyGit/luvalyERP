...
public class OCP_Autoriza extends javax.swing.JPanel {
    ...
    private void initComponents() {
        ...
        GrillaProductos.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "Codigo", "Nombre", "Unidad", "Cantidad", "Unitario", "% Mgn", "Total"
            }
        ) {
            Class[] types = new Class [] {
        ...
        GrillaDatos.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "Stock", "OCP", "OCC", "Vta 3M", "OCC 3M", "Ult.Costo", "P.Venta", "Minimo"
            }
        ) {
            Class[] types = new Class [] {
                java.lang.Integer.class, java.lang.Integer.class, java.lang.Integer.class, java.lang.Integer.class, java.lang.Integer.class, java.lang.Double.class, java.lang.Double.class, java.lang.Object.class
            };
            boolean[] canEdit = new boolean [] {
        ...
        GrillaOtros.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "Código", "Nombre", "Unidad", "P.Compra", "Stock", "OCP", "OCC", "VTA 3M", "OCC 3M", "Publicado"
            }
        ) {
            Class[] types = new Class [] {
        ...
        if (GrillaOtros.getColumnModel().getColumnCount() > 0) {
            ...
            GrillaOtros.getColumnModel().getColumn(9).setMinWidth(60);
            GrillaOtros.getColumnModel().getColumn(9).setPreferredWidth(60);
            GrillaOtros.getColumnModel().getColumn(9).setMaxWidth(60);
        }
...
//                System.out.println(e.getMessage());
    ...
    private void CargaProductos(int Numero){
        ...
        try {
            /*Rs = Sql.Select("select d.sku,p.nombre, u.unidad, d.cantidad,d.valorunitario,d.totallinea, i.stock,i.ocp,i.occ, p.valultcompra,p.pventa,\n" +
                            "\n" +
                            ...
                            "from ctacteclidet cd \n" +
                            "join ctactecli cc on cc.tipdocto=cd.tipdocto and cc.nrodocto=cd.nrodocto and cc.femision > current_date - 90 \n" +
                            "where cd.sku=d.sku and cd.tipdocto in ('FAC','FEC','FMC'))as cont\n" +
                            "\n" +
                            "from ctacteprvdet d\n" +
