...
public class GeneraDTE_FTP {
    ...
    private static int parGDC;
    private static int parOCC;
            ...
            if (Rs1.next()){
                ...
                if(!fmMain.GetInternet()){
                   ...
                   // server = "186.67.157.227";
                    ...
                    user  = Rs1.getString("usu");
                    puerto  = 10002;  // que apunta al puerto 21 (ftp);
                    pass = Rs1.getString("pass");
                }
            }
           //trae datos ftp
    ...
    public static boolean Generar2(String ParRut,String ParTipo, String ParNumero, int ParGDC, int ParOCC) throws SQLException {
        boolean Resultado=true;
        Rut = ParRut;
        Tipo = ParTipo;
        Numero = ParNumero;
    ...
    private static void ImprimeEncDocumento(BufferedWriter buffer,String Fecha){
        ...
        try {
            ...
            buffer.write( TipoNro + "|" + Numero +"|" + Fecha + "|||" + Traslado + "|"+TipoPago+"|}\r\n\n" );
    ...
    private static void ImprimeReferencia(BufferedWriter buffer) throws IOException {
        ...
        if (Tipo.equals("NCC") || Tipo.equals("NDC")) {
            try {
                ...
                if(CodRef.equals("3") || CodRef.equals("4") || CodRef.equals("5") ){
                ...
                buffer.write(TipoDocumento + "||"  
                        + Folio + "|"
                        + Fecha + "|"
                        + CodRef + "|"   //Tipo NCC : Anula (1), Corrige Texto (2), Corrige Monto (3), (Refacturación (4) o Descuento (5) se cambia a 3)
                        + Razon + "||}\r\n\n");
    ...
    private static void ImprimeReferencia2(BufferedWriter buffer) throws IOException {
        ExeSql Sql = new ExeSql();
        String TipoDocumento = "";
        String Folio = "";
        String Fecha = "";
        ...
        if (Tipo.equals("FAC")) {
            ...
            try {
                ...
                System.out.println("*******************************************************parGDC ES : "+parGDC);
                
                if (parGDC == 1){   //Lleva GDC de referencia
                ...
                }else if (parGDC == 0) {  //Sin GDC de referencia
        ...
        if (Tipo.equals("FAC")) {
            ...
            try {
                ...
                System.out.println("*****************************************************parOCC ES : "+parOCC);
                
                if (parOCC == 1){    //Lleva OCC de referencia
        ...
        if (Tipo.equals("NCC") || Tipo.equals("NDC")) {
            try {
                ...
                if(CodRef.equals("3") || CodRef.equals("4") ){
                ...
                buffer.write(TipoDocumento + "||"  
                        + Folio + "|"
                        + Fecha + "|"
                        + CodRef + "|"   //Tipo NCC : Anula (1), Corrige Texto (2), Corrige Monto (3) o (Refacturación (4) se cambia a 3)
                        + Razon + "||}\r\n\n");
    ...
    private static void ImprimeAdjuntos(BufferedWriter buffer) throws IOException{
        ...
        if(Tipo.equals("FAC")){
            ...
            try {
                ...
                DirEnvio=Rs.getString("observacion").trim();
        ...
        if(usuario.equals("equiroz") || usuario.equals("tzuniga") || usuario.equals("aquijon")){
            
            // buffer.write("|||"+ DirEnvio +"|||||||EPSON L375||}\r\n\n"); 
            // buffer.write("|||"+ DirEnvio +"|||||||DISOSUR||}\r\n\n"); 
               buffer.write("|||"+ DirEnvio +"|||||||NO IMPRIMIR||}\r\n\n");
      ...
      //    buffer.write("|||"+ DirEnvio +"|||||||BROTHER||}\r\n\n");
        //  buffer.write("|||"+ DirEnvio +"|||||||EPSON_VENTAS||}\r\n\n");
            buffer.write("|||"+ DirEnvio +"|||||||NO IMPRIMIR||}\r\n\n");
        }
