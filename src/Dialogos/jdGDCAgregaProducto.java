...
public class jdGDCAgregaProducto extends javax.swing.JDialog {
    ...
    public jdGDCAgregaProducto(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
...
//-----------------------------------------------------------------------------    
    ...
    public Object[] GetFilaOCP_Porcentaje(){
        ...
        try {
            ...
            Logger.getLogger(jdGDCAgregaProducto.class.getName()).log(Level.SEVERE, null, ex);
        }
        finally {
            sql.Close();
        }
...
//-----------------------------------------------------------------------------    
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(jdGDCAgregaProducto.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                jdGDCAgregaProducto dialog = new jdGDCAgregaProducto(new javax.swing.JFrame(), true);
