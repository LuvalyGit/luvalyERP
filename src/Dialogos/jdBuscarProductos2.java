 ...
 * @author DavidAlcaman
 */
public class jdBuscarProductos2 extends javax.swing.JDialog {
    ...
    private boolean descont2=false;
    private String matriz[][] = new String[10000][2];
    
    DefaultTableCellRenderer rightRenderer = new DefaultTableCellRenderer();
    
    
    public jdBuscarProductos2(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
...
//      DefaultTableModel tbMd = new DefaultTableModel();
        ...
        String sql = "SELECT  distinct p.sku, CASE WHEN id2.ids is NULL THEN '0' ELSE id2.ids END as id3,p.nombre,i.stock AS stock,"+
                     "p.notransado,p.desxprecio, p.sinstock, \n" +
                     "cd.discontinuado as disc1,p.discontinuado as disc2\n" +
                     "FROM producto p\n" +
                     "LEFT JOIN inventario i ON p.sku=i.sku \n" +
                     "LEFT JOIN (SELECT sku, STRING_AGG (idch, ' - ' ORDER BY idch) AS ids FROM codchile GROUP BY sku) id2 ON (p.sku = id2.sku) \n" +
                     "LEFT JOIN codchile cd ON p.sku = cd.sku WHERE p.sku is not null ";
         
        if(Insumos)
            sql = sql + "and insumo is true\n";
        else
        ...
        try {
            ...
            while (Rs.next()){
                ...
                descont=Rs.getBoolean("disc1");
                descont2=Rs.getBoolean("disc2");
    ...
    //**************************************************************************************************************************************************//            
              ...
              //  System.out.println("EL ID ES : "+ID);
                ...
                }else  if (ID.equals("0")) {   //NO PUBLICADOS
                               
                    
                     if (!descont2){
                    
                          tbMd.addRow(new Object[]{Rs.getString("sku"),"",Rs.getString("nombre"),Rs.getString("stock"),notran,desxpr,nstock,sala});
                     }
            ...
            Logger.getLogger(jdBuscarProductos2.class.getName()).log(Level.SEVERE, null, e);
        }
        finally {
            Sql.Close();
        }
...
//        Grilla.requestFocus();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(jdBuscarProductos2.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                jdBuscarProductos2 dialog = new jdBuscarProductos2(new javax.swing.JFrame(), true);
