 ...
 */
public class jdBuscaUbicacion2 extends javax.swing.JDialog {

    /**
     * Creates new form jdAjustePesos
     */
    public jdBuscaUbicacion2(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
...
//            if (ConTransito == 0){
//            
//                Query= Query + " where nombre NOT LIKE '" + "TRAN" + "%' ";
//            }
...
//                    if (nombrePalabra.substring(0,3).trim().equals("LVL") || nombrePalabra.substring(0,4).trim().equals("TRAN")){
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(jdBuscaUbicacion2.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                jdBuscaUbicacion2 dialog = new jdBuscaUbicacion2(new javax.swing.JFrame(), true);
