...
public class jdBuscaX extends javax.swing.JDialog {

int Tipo;
String RutSel;
    public jdBuscaX(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(jdBuscaX.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                jdBuscaX dialog = new jdBuscaX(new javax.swing.JFrame(), true);
