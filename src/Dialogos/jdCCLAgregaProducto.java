...
public class jdCCLAgregaProducto extends javax.swing.JDialog {
    ...
    private void initComponents() {
        ...
        listProveedor = new javax.swing.JList<String>();
        jLabel6 = new javax.swing.JLabel();
        btVempresas = new javax.swing.JToggleButton();
        lbVempresas = new javax.swing.JLabel();
        ...
        btVempresas.setText("Venta Empresas");
        btVempresas.setToolTipText("");
        btVempresas.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                btVempresasActionPerformed(evt);
            }
        });

        lbVempresas.setHorizontalAlignment(javax.swing.SwingConstants.RIGHT);
        lbVempresas.setText("0");
        lbVempresas.setToolTipText("");
        lbVempresas.setBorder(javax.swing.BorderFactory.createLineBorder(new java.awt.Color(0, 0, 0)));
                                ...
                                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                                    .addGroup(layout.createSequentialGroup()
                                        .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                                            ...
                                            .addComponent(txCantidad, javax.swing.GroupLayout.PREFERRED_SIZE, 62, javax.swing.GroupLayout.PREFERRED_SIZE)
                                            .addGroup(layout.createSequentialGroup()
                                                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                                                    .addComponent(txUnidad, javax.swing.GroupLayout.PREFERRED_SIZE, 120, javax.swing.GroupLayout.PREFERRED_SIZE)
                                                    .addComponent(txStock, javax.swing.GroupLayout.PREFERRED_SIZE, 49, javax.swing.GroupLayout.PREFERRED_SIZE))
                                                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                                                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                                                    .addComponent(cbUnidades, javax.swing.GroupLayout.PREFERRED_SIZE, 98, javax.swing.GroupLayout.PREFERRED_SIZE)
                                                    .addComponent(txUM, javax.swing.GroupLayout.PREFERRED_SIZE, 41, javax.swing.GroupLayout.PREFERRED_SIZE))))
                                        .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED))
                                    .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, layout.createSequentialGroup()
                                        .addComponent(txPrecio, javax.swing.GroupLayout.PREFERRED_SIZE, 78, javax.swing.GroupLayout.PREFERRED_SIZE)
                                        .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
                                        .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING, false)
                                            .addComponent(lbVoculto, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
                                            .addComponent(lbVempresas, javax.swing.GroupLayout.DEFAULT_SIZE, 65, Short.MAX_VALUE))
                                        .addGap(42, 42, 42))))
                            .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, layout.createSequentialGroup()
                                .addContainerGap()
                                .addComponent(btVempresas)
                                .addGap(18, 18, 18)))
                        .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            .addGroup(layout.createSequentialGroup()
                ...
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addGroup(layout.createSequentialGroup()
                        ...
                        .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                            ...
                            .addComponent(lbVempresas, javax.swing.GroupLayout.PREFERRED_SIZE, 20, javax.swing.GroupLayout.PREFERRED_SIZE))
                        .addGap(3, 3, 3)
                        .addComponent(btVempresas, javax.swing.GroupLayout.PREFERRED_SIZE, 34, javax.swing.GroupLayout.PREFERRED_SIZE))
...
//                Rs.next();
    ...
    private void btVempresasActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btVempresasActionPerformed

         simbolo.setDecimalSeparator('.');
         DecimalFormat formateador = new DecimalFormat("0.000",simbolo);
        
        
        if (btVempresas.isSelected()){
        ...
        }else if (!btVempresas.isSelected()) {

            txPrecio.setText("0");

        }
    }//GEN-LAST:event_btVempresasActionPerformed
...
//-----------------------------------------------------------------------------    
    private void CargaProductos(String Codigo){
        ...
        try{
            Rs = Sql.Select("select p.discontinuado, p.sku,p.nombre,u.unidad,u.um,p.valultcompra, i.stock \n" +
                            "from producto p\n" +
                            ...
                            "where (p.sku='" + Codigo + "' or p.sku = (select sku from codchile where idch = '"+Codigo+"')"
                                    + " or p.sku = (select sku from codbar where codbar = '"+Codigo+"'))");
            ...
            //txStock.setForeground(new Color(0, 0, 0));
            ...
            lbVempresas.setText("$ "+fmMain.FormatoNumeroSinDecimal(cost_vent_empresa));
    ...
    private javax.swing.JToggleButton btVempresas;
    ...
    private javax.swing.JLabel lbVempresas;
