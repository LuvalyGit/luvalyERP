 ...
 */
public class jdContactos_Econa extends javax.swing.JDialog {
    String Eliminados;
    int EliminadosCont;
    String IdContacto="";
     ...
     */
    public jdContactos_Econa(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(jdContactos_Econa.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                jdContactos_Econa dialog = new jdContactos_Econa(new javax.swing.JFrame(), true);
