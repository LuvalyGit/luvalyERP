...
public class jdBuscarCliPrv2 extends javax.swing.JDialog {

int Tipo;
String RutSel;
String NomSel;
    public jdBuscarCliPrv2(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(jdBuscarCliPrv2.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                jdBuscarCliPrv2 dialog = new jdBuscarCliPrv2(new javax.swing.JFrame(), true);
