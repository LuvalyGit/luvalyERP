...
public class jdNVCAgregaProducto extends javax.swing.JDialog {
    ...
    public jdNVCAgregaProducto(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
...
//-----------------------------------------------------------------------------    
    ...
    public Object[] GetFilaOCP_Porcentaje(){
        ...
        try {
            ...
            Logger.getLogger(jdNVCAgregaProducto.class.getName()).log(Level.SEVERE, null, ex);
        }
        finally {
            sql.Close();
        }
...
//-----------------------------------------------------------------------------    
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(jdNVCAgregaProducto.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                jdNVCAgregaProducto dialog = new jdNVCAgregaProducto(new javax.swing.JFrame(), true);
