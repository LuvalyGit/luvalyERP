...
//        cbCargoId.setVisible(false);
    ...
    public void ConTipo(String tipo){
        ...
        try {
            ...
            //System.out.println(e.getMessage());
            Logger.getLogger(jdAddDatosPersona.class.getName()).log(Level.SEVERE, null, e);
        } finally{
            Sql.Close();
            Cargando=0;
        }
    ...
    public void Editar(int edicion, String nombre, String fono, String celular, String mail,int id, String cargo){
        ...
        System.out.println("editando ES = "+editando);
    ...
    private void btAceptarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btAceptarActionPerformed
        ...
        if (editando==1){
            ...
            try{
                Sql.ExeSql("UPDATE clicontactopersonas SET \n" +
                           "nombre='"+txNombre.getText().trim()+"', fono='"+txFono.getText().trim()+"', \n" +
                           "celular='"+txCelular.getText().trim()+"', email='"+txCorreo.getText().trim()+"', \n"+
                           "id_cargo="+cbCargoId.getSelectedItem()+", \n"+
        ...
        if (editando==3){
            ...
            try{
                ...
                Sql.ExeSql("UPDATE prv_contacto SET \n" +
                           "nombre='"+txNombre.getText().trim()+"', fono1='"+txFono.getText().trim()+"', \n" +
                           "fono2='"+txCelular.getText().trim()+"', email='"+txCorreo.getText().trim()+"', \n"+
                           "tipo="+cbCargoId.getSelectedItem()+ " \n"+
                           "where id="+idcontacto);
                Sql.Commit();
        ...
        if (nuevocon==1){
            ...
            try{
                ...
                Sql.ExeSql("INSERT into clicontactopersonas \n" +
                           ...
                           "("+rut+", "+codigo_oc+", '"+txNombre.getText().trim()+"', '"+txFono.getText().trim()+"',\n"+
                           "'"+txCelular.getText().trim()+"', '"+txCorreo.getText().trim()+"', "+cbCargoId.getSelectedItem()+")");
                Sql.Commit();
