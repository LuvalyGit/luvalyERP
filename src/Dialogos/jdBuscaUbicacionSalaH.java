 ...
 */
public class jdBuscaUbicacionSalaH extends javax.swing.JDialog {

    /**
     * Creates new form jdAjustePesos
     */
    public jdBuscaUbicacionSalaH(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    ...
    public void CargaBodegaOR(int ConTransito){
        ...
        try {
            ...
            Query="SELECT split_part(mt.nombre, '-',1) AS nombre \n"+
                  "FROM mt_codmetro mt \n"+
                  "WHERE split_part(mt.nombre, '-',1) LIKE '%SALATH%' or split_part(mt.nombre, '-',1) LIKE '%PATIOTH%' \n"+
                  "GROUP BY split_part(mt.nombre, '-',1) order by split_part(mt.nombre, '-',1);";
...
//        CboProveedor.setSelectedIndex(0);
        ...
        try {
            ...
            Query ="SELECT split_part(mt.nombre, '-',2) AS nombre \n"+
                   "FROM mt_codmetro mt \n"+
                   "where split_part(mt.nombre, '-',1) = '"+cbBodegaOR.getSelectedItem().toString().trim()+"' AND habilita = 1 \n"+
...
//                    if (nombrePalabra.substring(0,3).trim().equals("LVL") || nombrePalabra.substring(0,4).trim().equals("TRAN")){
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(jdBuscaUbicacionSalaH.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                jdBuscaUbicacionSalaH dialog = new jdBuscaUbicacionSalaH(new javax.swing.JFrame(), true);
