...
public class jdBOCAgregaProducto extends javax.swing.JDialog {
    ...
    public jdBOCAgregaProducto(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
...
//-----------------------------------------------------------------------------    
    ...
    public Object[] GetFilaOCP_Porcentaje(){
        ...
        try {
            ...
            Logger.getLogger(jdBOCAgregaProducto.class.getName()).log(Level.SEVERE, null, ex);
        }
        finally {
            sql.Close();
        }
...
//-----------------------------------------------------------------------------    
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(jdBOCAgregaProducto.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                jdBOCAgregaProducto dialog = new jdBOCAgregaProducto(new javax.swing.JFrame(), true);
