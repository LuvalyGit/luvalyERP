 ...
 * @author DavidAlcaman
 */
public class jdBuscarProductosTransforma extends javax.swing.JDialog {
    ...
    public jdBuscarProductosTransforma(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
...
public void SetCotiza(Boolean Cotiza){
    ...
    private void initComponents() {
        ...
        jPanel1Layout.setHorizontalGroup(
            ...
            .addGroup(jPanel1Layout.createSequentialGroup()
                ...
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addComponent(txSku, javax.swing.GroupLayout.PREFERRED_SIZE, 169, javax.swing.GroupLayout.PREFERRED_SIZE))
        ...
        Grilla.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "Código", "ID", "Nombre", "Stock", "notran", "desxprecio", "nostock", "Web", "ML", "Sala"
            }
        ) {
            Class[] types = new Class [] {
                java.lang.Object.class, java.lang.Object.class, java.lang.Object.class, java.lang.String.class, java.lang.Object.class, java.lang.Object.class, java.lang.Object.class, java.lang.Boolean.class, java.lang.Boolean.class, java.lang.Boolean.class
            };
        ...
        if (Grilla.getColumnModel().getColumnCount() > 0) {
            ...
            Grilla.getColumnModel().getColumn(9).setPreferredWidth(40);
            Grilla.getColumnModel().getColumn(9).setMaxWidth(40);
        }
    ...
    public void buscar_prod(Boolean cotiza){
         ...
         System.out.println("cotiza 1 ES :"+cotiza);
...
//      DefaultTableModel tbMd = new DefaultTableModel();
        ...
        String sql = "SELECT p.sku,id2.ids,p.nombre,i.stock AS stock,p.notransado,p.desxprecio, sinstock, \n"+
                     "case when cw.publicado is null then false else cw.publicado end as publica, p.nropublicacion  \n" +
                     "FROM producto p\n" +
...
//            tbMd = c.returndata(sql);
    ...
    //**************************************************************************************************************************************************//            
                ...
                tbMd.addRow(new Object[]{Rs.getString("sku"),ID,Rs.getString("nombre").trim(),Rs.getString("stock"),notran,desxpr,nstock,Rs.getBoolean("publica"),ml,sala});
    ...
    public void buscar_sku(Boolean cotiza){
        ...
        if(Insumos)
            ...
            sql = sql + "and p.sku IN ('" + txSku.getText().trim() + "') ";
...
//        Grilla.requestFocus();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(jdBuscarProductosTransforma.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                jdBuscarProductosTransforma dialog = new jdBuscarProductosTransforma(new javax.swing.JFrame(), true);
