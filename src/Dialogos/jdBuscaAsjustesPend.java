...
public class jdBuscaAsjustesPend extends javax.swing.JDialog {
    int ModalResult;
    String NumeroMaster;
    String TipoMaster;
    boolean Estado = false;
    
    public jdBuscaAsjustesPend(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        if (Grilla.getColumnModel().getColumnCount() > 0) {
            ...
            Grilla.getColumnModel().getColumn(1).setPreferredWidth(40);
        }
...
// SHOW MODAL
//------------------------------------------------------------------------------
    public int ShowModal(String Sku){
    ...
    public void CargaDocumentos(String Sku){
        ...
        String sql = "select a.folio, a.cantidad from ajustedet_autoriza a \n" +
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(jdBuscaAsjustesPend.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                jdBuscaAsjustesPend dialog = new jdBuscaAsjustesPend(new javax.swing.JFrame(), true);
