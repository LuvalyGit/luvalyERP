 ...
 */
public class jdBuscaUbicacionTraslados extends javax.swing.JDialog {

    /**
     * Creates new form jdAjustePesos
     */
    public jdBuscaUbicacionTraslados(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    ...
    public void CargaBodegaOR(int ConTransito){
        ...
        try {
            ...
            Query="SELECT split_part(mt.nombre, '-',1) AS nombre \n"+
                  "FROM mt_codmetro mt \n"+
                  "WHERE split_part(mt.nombre, '-',1) LIKE '%BODEGA%' \n"+
...
//                    if (nombrePalabra.substring(0,3).trim().equals("LVL") || nombrePalabra.substring(0,4).trim().equals("TRAN")){
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(jdBuscaUbicacionTraslados.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                jdBuscaUbicacionTraslados dialog = new jdBuscaUbicacionTraslados(new javax.swing.JFrame(), true);
