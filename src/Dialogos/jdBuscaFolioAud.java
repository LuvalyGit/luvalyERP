...
public class jdBuscaFolioAud extends javax.swing.JDialog {
    int ModalResult;
    String NumeroMaster;
    String TipoMaster;
    boolean Estado = false;
    
    public jdBuscaFolioAud(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    }
...
//------------------------------------------------------------------------------
    ...
    public void CargaDocumentos(String Sku){
        ...
        String sql = "SELECT distinct folio, \n"+
                     ...
                     "end as estado, \n"+
                     "CAST( (diferencia * -1) AS int) as pendientes  \n"+
                     "FROM mt_auditoria_ubicaciones \n"+
                     "WHERE sku IN ('"+Sku+"') AND CAST( (diferencia * -1) AS int) > 0 \n"+
                     "ORDER BY folio desc";
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(jdBuscaFolioAud.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                jdBuscaFolioAud dialog = new jdBuscaFolioAud(new javax.swing.JFrame(), true);
