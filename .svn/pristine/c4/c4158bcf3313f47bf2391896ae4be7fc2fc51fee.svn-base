...
public class jdBuscarCliCartera extends javax.swing.JDialog {

int Tipo;
String RutSel;
    public jdBuscarCliCartera(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(jdBuscarCliCartera.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                jdBuscarCliCartera dialog = new jdBuscarCliCartera(new javax.swing.JFrame(), true);
