 ...
 * @author DavidAlcaman
 */
public class jd_UbicacionesP_Econa extends javax.swing.JDialog {
   DefaultTableCellRenderer rightRenderer = new DefaultTableCellRenderer();
     ...
     */
    public jd_UbicacionesP_Econa(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    ...
    private void initComponents() {
        ...
        if (Grilla.getColumnModel().getColumnCount() > 0) {
            ...
            Grilla.getColumnModel().getColumn(3).setMinWidth(180);
            Grilla.getColumnModel().getColumn(3).setPreferredWidth(180);
...
//            " where b.codigo='" + ubicaArray[0] + "' and r.codigo= " + ubicaArray[1] +  " and m.codigo= " + ubicaArray[2] + "  and m.rack=" + ubicaArray[1];
    ...
    public void CargaBultos(String sku, String nombre){
        ...
        try {
            Query = "select mp.sku, p.nombre,mp.ubicacion,u.unidad,sum(mp.cant) cantidad \n" +
                    ...
                    //"where  mp.ubicacion <>'TRAN.1001.1'\n" +
    ...
    public void abrir(String file ){
       ...
       try {
           ...
           Logger.getLogger(jd_UbicacionesP_Econa.class.getName()).log(Level.SEVERE, null, ex);
       }
...
//        UbicaCodigo_Sel = Grilla.getValueAt(Grilla.getSelectedRow(),3).toString();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(jd_UbicacionesP_Econa.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                jd_UbicacionesP_Econa dialog = new jd_UbicacionesP_Econa(new javax.swing.JFrame(), true);
